...
namespace SuperWoman
{
    ...
    /// </summary>
    public sealed partial class BrCheck : Page
    {
        ...
        private void myDataManager_DataRequested(Windows.ApplicationModel.DataTransfer.DataTransferManager sender, Windows.ApplicationModel.DataTransfer.DataRequestedEventArgs args)
        {
            DataPackage myData = args.Request.Data;
            myData.Properties.Title = "Hello all Women of the World!";
            string localImage = "ms-appx:///Images/exam.jpg";
            string htmlExample = "<p>Share this image on breast examination with all the women you know <img src=\"" + localImage + "\">.</p>";
